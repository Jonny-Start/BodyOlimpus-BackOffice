# Para que el SVG cambie de color dependiendo el color que se le mande en el contenedor, tendremos que modificar el SVG cambiando el Stilo a "currentColor", por ejemplo:
